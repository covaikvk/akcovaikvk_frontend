...
const mapApiDataToMenuItems = (apiData) => {
  ...
  const snacksCategories = apiData.filter(
    (category) => category.category?.toLowerCase() === "snacks"
  );
  return snacksCategories.map((category) => ({
    ...
    <View style={{ flex: 1, backgroundColor: "#eaf7e9" }}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerOverlay}>
          ...
          <Text style={styles.headerSubtitle}>Tasty Bites Anytime!</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { height: responsive(220), width: "100%" },
  ...
  headerTitle: { fontSize: responsive(40), fontWeight: "bold", color: "#fff" },
  headerSubtitle: { fontSize: responsive(20), color: "#fff", marginTop: responsive(6) },
